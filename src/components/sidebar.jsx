...
function Sidebar() {
    ...
    return (
        <div className="flex justify-center md:flex-col space-y-1 py-1.5 md:py-3.5 lg:!py-[14px]">
            {sidebarMenu.map((item, index) => (
                ...
                >
                    <div className={router.pathname === item.href 
                        ? 'text-white bg-[#448ed2] hover:text-white shadow-lg shadow-[#00000040]/25 w-10 h-10 md:w-0 md:h-0 flex items-center justify-center rounded-full' 
